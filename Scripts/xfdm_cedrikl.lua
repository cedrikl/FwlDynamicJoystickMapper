...
xfdm:requestMapping("cmd_at_cws",             xfdmConInButton, sidestick.fliptrig_ctr)
...
xfdm:requestMapping("toggle_trackir",         xfdmConInButton, sidestick.bl_button)
xfdm:requestMapping("trim_pitch_up",          xfdmConInButton, sidestick.br_hat_down)
xfdm:requestMapping("trim_pitch_down",        xfdmConInButton, sidestick.br_hat_up)
