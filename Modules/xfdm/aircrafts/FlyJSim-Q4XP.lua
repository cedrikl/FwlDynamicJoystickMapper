...
xfdm:requestConnector("q4xp_lights_strobe_pos",      xfdmConOutRoDataref,   "FJS/Q4XP/Manips/TwoSwitch_Anim")
xfdm:requestConnector("q4xp_lights_strobe_up",       xfdmConOutSimCommand,  "FJS/Q4XP/Switches/ACOL_up")
xfdm:requestConnector("q4xp_lights_strobe_dn",       xfdmConOutSimCommand,  "FJS/Q4XP/Switches/ACOL_dn")
...
function xfdm_set_strobe_light()
  ...
  if (tSwPos and (tStrobePos ~= 1)) then
    xfdm:driveConnectorDest("q4xp_lights_strobe_dn")
  elseif (not(tSwPos) and (tStrobePos > 0)) then
    xfdm:driveConnectorDest("q4xp_lights_strobe_up")
  end
end
