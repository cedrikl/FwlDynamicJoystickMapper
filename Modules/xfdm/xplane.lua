...
xfdm:requestConnector("trim_pitch_up1",               xfdmConOutSimCommand, "sim/flight_controls/pitch_trimA_up")
xfdm:requestConnector("trim_pitch_down1",             xfdmConOutSimCommand, "sim/flight_controls/pitch_trimA_down")
xfdm:requestConnector("trim_pitch_up2",               xfdmConOutSimCommand, "sim/flight_controls/pitch_trimB_up")
xfdm:requestConnector("trim_pitch_down2",             xfdmConOutSimCommand, "sim/flight_controls/pitch_trimB_down")
xfdm:requestConnector("trim_rudder_left",             xfdmConOutSimCommand, "sim/flight_controls/rudder_trim_left")
xfdm:requestConnector("trim_rudder_right",            xfdmConOutSimCommand, "sim/flight_controls/rudder_trim_right")
xfdm:requestConnector("trim_rudder_left1",            xfdmConOutSimCommand, "sim/flight_controls/rudder_trimA_left")
xfdm:requestConnector("trim_rudder_right1",           xfdmConOutSimCommand, "sim/flight_controls/rudder_trimA_right")
xfdm:requestConnector("trim_rudder_left2",            xfdmConOutSimCommand, "sim/flight_controls/rudder_trimB_left")
xfdm:requestConnector("trim_rudder_right2",           xfdmConOutSimCommand, "sim/flight_controls/rudder_trimB_right")

xfdm:requestConnector("view_up",                      xfdmConOutSimCommand, "sim/general/hat_switch_up")
xfdm:requestConnector("view_up_right",                xfdmConOutSimCommand, "sim/general/hat_switch_up_right")
xfdm:requestConnector("view_right",                   xfdmConOutSimCommand, "sim/general/hat_switch_right")
xfdm:requestConnector("view_down_right",              xfdmConOutSimCommand, "sim/general/hat_switch_down_right")
xfdm:requestConnector("view_down",                    xfdmConOutSimCommand, "sim/general/hat_switch_down")
xfdm:requestConnector("view_down_left",               xfdmConOutSimCommand, "sim/general/hat_switch_down_left")
xfdm:requestConnector("view_left",                    xfdmConOutSimCommand, "sim/general/hat_switch_left")
...
xfdm:requestConnector("elec_gen_on",                  xfdmConOutSimCommand, "sim/electrical/generator_1_on")
xfdm:requestConnector("elec_gen_off",                 xfdmConOutSimCommand, "sim/electrical/generator_1_off")
...
xfdm:requestConnector("lights_bcn_on",                xfdmConOutSimCommand, "sim/lights/beacon_lights_on")
xfdm:requestConnector("lights_bcn_off",               xfdmConOutSimCommand, "sim/lights/beacon_lights_off")
xfdm:requestConnector("lights_nav_on",                xfdmConOutSimCommand, "sim/lights/nav_lights_on")
xfdm:requestConnector("lights_nav_off",               xfdmConOutSimCommand, "sim/lights/nav_lights_off")
...
xfdm:requestConnector("vr_menu",                      xfdmConOutSimCommand, "sim/VR/reserved/menu")
xfdm:requestConnector("vr_reset_view",                xfdmConOutSimCommand, "sim/VR/general/reset_view")
